...
这是您可以在 Quick Reference 备忘单上使用的样式参考，快速参与[贡献](https://github.com/pleb631/reference/blob/main/CONTRIBUTING.md)！
...
将仓库克隆到本地调试页面。请参阅[贡献指南](https://github.com/pleb631/reference/blob/main/CONTRIBUTING.md)了解如何开始

#### 克隆仓库

```shell
git clone git@github.com:pleb631/reference.git
```
...
- 图标存放在 [`/assets`](https://github.com/pleb631/reference/tree/main/assets) 目录中
...
[鼠标移动到上面有提示](https://github.com/pleb631/reference) _Tooltips 的提示内容_<!--rehype:tooltips-->
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L774-L775)<!--rehype:target=__blank--> 在 `Title 1` 标题添加 `col-span-2` 和 `row-span-2` 占位类，使用 `空格` 间隔。
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L806-L823)<!--rehype:target=__blank--> 标题为 `H4` 的基本表格。
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L827-L836)<!--rehype:target=__blank--> `<!--rehype:className=shortcuts-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L839-L844)<!--rehype:target=__blank--> `<!--rehype:className=show-header-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L850-L855)<!--rehype:target=__blank--> `<!--rehype:className=style-list-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L861-L866)<!--rehype:target=__blank--> `<!--rehype:className=style-list-arrow-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L872-L877)<!--rehype:target=__blank--> `<!--rehype:className=auto-wrap-->`
...
[#示例](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L884-L888)<!--rehype:target=__blank--> 默认表格末尾列`右对齐`，添加 `<!--rehype:className=left-align-->` 类让其`左对齐`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L894-L898)<!--rehype:target=__blank-->  添加 `<!--rehype:className=code-nowrap-->`
...
[#示例](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L905-L909)<!--rehype:target=__blank-->
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L913-L921)<!--rehype:target=__blank--> `<!--rehype:className=cols-4-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L928-L945)<!--rehype:target=__blank--> `<!--rehype:className=style-timeline-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L951-L960)<!--rehype:target=__blank--> `<!--rehype:className=cols-3 style-none-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L966-L969)<!--rehype:target=__blank--> `<!--rehype:className=style-round-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L975-L978)<!--rehype:target=__blank--> `<!--rehype:className=style-arrow-->`
...
[#示例](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1012-L1021)<!--rehype:target=__blank-->
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1020-L1027)<!--rehype:target=__blank--> `<!--rehype:wrap-class=row-span-2-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1020-L1027)<!--rehype:target=__blank--> `<!--rehype:wrap-class=col-span-2-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1038-L1043)<!--rehype:target=__blank-->  `<!--rehype:style=background:#e91e63;-->`
...
[#](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1047-L1052)<!--rehype:target=__blank--> `<!--rehype:style=background:#d7a100;-->`

### col-span-3
<!--rehype:wrap-class=col-span-3-->

... [#示例](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1056-L1061)<!--rehype:target=__blank--> 三列合并

### 卡片子项

[#示例](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1063-L1077)<!--rehype:target=__blank--> 每个部分可以有以下子项：
...
[#示例](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1079-L1083)<!--rehype:target=__blank--> 这是一个包含段落的基本部分
...
[#示例](https://github.com/pleb631/reference/blob/main/docs/quickreference.md?plain=1#L1085-L1087)<!--rehype:target=__blank-->
