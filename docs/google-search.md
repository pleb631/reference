...
| Operator     | Description                                                | Category   |
| ------------ | ---------------------------------------------------------- | ---------- |
| `after:`     | 筛选指定日期之后更新的网页；也可用于 Drive 或 Mail。          | 高级、云端硬盘、邮件 |
| `before:`    | 筛选指定日期之前更新的网页；也可用于 Drive 或 Mail。          | 高级、云端硬盘、邮件 |
| `older:`     | 搜索早于某日期的邮件。                                     | 邮件       |
| `newer:`     | 搜索晚于某日期的邮件。                                     | 邮件       |
<!--rehype:className=left-align-->
...
- [优化 Google 搜索](https://support.google.com/websearch/answer/2466433?hl=zh-Hans)
  _(support.google.com)_
